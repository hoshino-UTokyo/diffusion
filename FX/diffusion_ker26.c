...
void allocate_ker26(REAL **buff_ret, const int nx, const int ny, const int nz) {

  posix_memalign((void**)buff_ret, 64, sizeof(REAL)*nx*ny*nz);

}

void init_ker26(REAL *buff1, const int nx, const int ny, const int nz,
...
void diffusion_ker26(REAL *restrict f1, REAL *restrict f2, int nx, int ny, int nz,
